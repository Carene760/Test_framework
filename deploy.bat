...
set FRAMEWORK_JAR=.\src\main\webapp\WEB-INF\lib\framework.jar
...
if exist "%SRC%\com\cousin\model\*.java" (
    ...
    javac -classpath "%TOMCAT_LIB%\servlet-api.jar;%FRAMEWORK_JAR%" -d %BUILD%\WEB-INF\classes "%SRC%\com\cousin\model\*.java"
)
